...
class PathWatcherProviderImpl implements PathWatcherProvider {
  ...
  @Override
  public NoFollowSymlinks<Event> noFollowSymlinks(Logger logger)
  ...
  @Override
  public FollowSymlinks<Event> followSymlinks(Logger logger)
      throws IOException, InterruptedException {
    final DirectoryRegistry registry = new DirectoryRegistryImpl();
  ...
  private static NoFollowSymlinks<Event> get(final DirectoryRegistry registry, final Logger logger)
