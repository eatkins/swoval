 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_swoval_files_impl_NativeDirectoryLister_errno
 ...
 */
JNIEXPORT jlong JNICALL Java_com_swoval_files_impl_NativeDirectoryLister_openDir
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_swoval_files_impl_NativeDirectoryLister_closeDir
  (JNIEnv *, jobject, jlong);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_swoval_files_impl_NativeDirectoryLister_nextFile
  (JNIEnv *, jobject, jlong);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_swoval_files_impl_NativeDirectoryLister_getType
  (JNIEnv *, jobject, jlong);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_swoval_files_impl_NativeDirectoryLister_getName
  (JNIEnv *, jobject, jlong);
